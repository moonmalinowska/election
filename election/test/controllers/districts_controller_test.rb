...
class DistrictsControllerTest < ActionController::TestCase
  ...
  test "should create district" do
    assert_difference('District.count') do
      post :create, district: { electorate: @district.electorate, mandate: @district.mandate, name: @district.name }
    end
  ...
  test "should update district" do
    patch :update, id: @district, district: { electorate: @district.electorate, mandate: @district.mandate, name: @district.name }
    assert_redirected_to district_path(assigns(:district))
  end
